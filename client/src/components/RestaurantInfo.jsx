          ...
          <div className="bg-white shadow-md rounded-s-sm overflow-hidden">
            ...
            <div className="mt-8 mx-10">
                    <h3 className="text-2xl font-semibold text-gray-900 mb-4">
                      <MdComment className="inline-block mr-2" /> Leave a Review
                    </h3>
                    <form onSubmit={handleSubmitReview}>
                      <textarea
                        ...
                        className="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:border-red-500 mb-4"
                      />
                      <button type="submit" className="bg-red-500 text-white py-2 px-6 rounded hover:bg-red-600 transition duration-200">
                        Submit Review
                      </button>
                    </form>
                    ...
                    {/* Displaying reviews */}
                    <div className="mt-6">
                      <h3 className="text-2xl font-semibold text-gray-900 mb-4">User Reviews</h3>
                      {reviews.length > 0 ? (
