...
import FoodVideoScroll from "./components/FoodVideoScroll";
  ...
  return (
    <div className="App">
      <BrowserRouter>
        <Routes>
          <Route
            element={<LandingPage setRestaurantName={setRestaurantName} />}
          >
            ...
            <Route path="/videoScroll" element={<FoodVideoScroll />} />
          </Route>
